...
restart_container() {
    ...
    docker exec -itd vnc bash -c "chmod +x /usr/local/lib/web/frontend/static/novnc/utils/launch.sh"
    docker exec -itd vnc bash -c "/usr/local/lib/web/frontend/static/novnc/utils/launch.sh --listen 6081 --vnc localhost:5900"
